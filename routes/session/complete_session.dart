...
Future<void> handleCompleteSession(HttpRequest request, int userId) async {
  print('[SessionRoutes] 🟢 handleCompleteSession called by user $userId');
  ...
  try {
    ...
    final result = await SessionService().completeSession(sessionId, userId);
    ...
    print("❌ Exception in handleCompleteSession: $e\n$st");
    request.response
      ..statusCode = 500
      ..headers.contentType = ContentType.json
